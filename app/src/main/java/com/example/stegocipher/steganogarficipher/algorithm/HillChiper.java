...

{
    ...
    public String mInverseKey="";
    
    int numberOfChar=95;
    
    int startASCIIchar=32;
    

    public String getmInverseKey() {
        return mInverseKey;
    }

    public void setmInverseKey(String mInverseKey) {
        this.mInverseKey += mInverseKey;
    }
...

    {
...

        {
...

            {
                ...
                keymatrix[i][j] = ((int) key.charAt(c)) - startASCIIchar;
...

    {
...

        {
            ...
            linematrix[i] = ((int) line.charAt(i)) - startASCIIchar;
...

    {
...

        {
            ...
            result += (char) (resultmatrix[i] + startASCIIchar);
  ...
  public static boolean isPrime(int n) {
...

    {
        ...
        //int mi = mi(d % numberOfChar);
        //mi %= numberOfChar;

        //find modulo inverse
        BigInteger dbig =new BigInteger(String.valueOf(d));
        BigInteger numcharbig =new BigInteger(String.valueOf(numberOfChar));
        BigInteger mis=dbig.modInverse(numcharbig);
        int mi=mis.intValue();
...

        {
...

            {
                ...
                inv[i][j] = b[i][j] % numberOfChar;

                if (inv[i][j] < 0)

                    inv[i][j] += numberOfChar;
...

    {
...

        {
...

            {
                ...
                invkey += (char) (inv[i][j] + startASCIIchar);
